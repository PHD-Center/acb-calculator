...
- **中英文商品名搜尋**:整合健保藥品資料庫 (NHI_ATCcode) 共 5,650 餘筆品牌名稱(英文 ≈2,500、中文 ≈3,150),已自動清除劑型、劑量、化學鹽/水合物、藥廠後綴 (Sandoz/Teva/PCH 等)、商標符號 (TM/®)、給藥途徑代碼 (S.C/I.V/S.R)、釋放型態 (Lyo/Retard/Orodispersible) 與其他贅字;輸入「思樂康」、「Seroquel」、「煩寧」即可對應到對應學名(Quetiapine、Diazepam),建議框副標以靛藍色顯示匹配之商品名供確認
